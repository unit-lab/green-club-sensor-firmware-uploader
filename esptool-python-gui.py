...
class MainFrame(wx.Frame):
    ...
    def __init__(self, parent):
        wx.Frame.__init__(self, parent, id=wx.ID_ANY, title="Green Club Sensor Firmware Uploader", pos=wx.DefaultPosition,
        ...
        self.title_label = wx.StaticText(self, wx.ID_ANY, u"Use this tool to upload firmware to your Green Club Sensor!", wx.DefaultPosition,
                                         wx.DefaultSize, 0)
